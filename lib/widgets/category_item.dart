...
Widget Item(wsize, hsize, item, provider, context) {
  return Padding(
      padding: EdgeInsets.only(left: wsize * 0.02, right: wsize * 0.02, top: wsize * 0.03),
      child: Container(
        // width: wsize * .3,
        height: hsize * .145,
        decoration: BoxDecoration(
          ...
          boxShadow: [BoxShadow(offset: const Offset(2.0, 2.0), color: Colors.black26, blurRadius: wsize * .025)],
        ),
                  ...
                  children: [
                    Padding(
                      ...
                      child: item.title.toString().length > 20
                          ? AutoSizeText('${item.title.toString().substring(0, 17)}...',
                              maxLines: 1, style: GoogleFonts.mulish(fontWeight: FontWeight.w600, fontSize: wsize * 0.04, color: Colors.black87))
                    ...
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          AutoSizeText("Price : ",
                              style: GoogleFonts.mulish(color: AppConfig.primaryColor, fontSize: wsize * 0.045, fontWeight: FontWeight.w500)),
                          AutoSizeText("\$${item.price}",
                              style: GoogleFonts.mulish(color: Colors.black, fontSize: wsize * 0.045, fontWeight: FontWeight.bold)),
                        ],
                      ),
                    ),
                  ],
