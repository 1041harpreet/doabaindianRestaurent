...
class CartlistBuilder extends ConsumerWidget {
  const CartlistBuilder({Key? key}) : super(key: key);
...
class listBuilder extends ConsumerWidget {
  var catname;
  listBuilder({Key? key,required this.catname}) : super(key: key);
...
class MadeForYouList extends ConsumerWidget {
  const MadeForYouList({Key? key}) : super(key: key);
...
class largeItem extends StatelessWidget {
  var item;
  largeItem({Key? key,required this.item}) : super(key: key);
