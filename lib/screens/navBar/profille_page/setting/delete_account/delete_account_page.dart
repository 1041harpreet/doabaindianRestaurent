      ...
      appBar: AppBar(
        ...
        actions: [
          Tooltip(child: Padding(
            ...
            message: "once your account is deleted,all of your content will be gone, including order details.You can not recover after that.",
         ...
         child: Padding(
           ...
           child: Column(children: [
             ...
             authprovider.deleteload == true
                 ? loadingButton(size)
                 : Button(
                 size, "Delete My Account", Colors.white, AppConfig.primaryColor,
                     () async {
                   if (notificationprovider.deleteAccountForm.valid) {
                     await authprovider.deleteAccount(context,notificationprovider.deleteAccountForm.control('current').value);
                   } else {
                     print('invalid');
                     notificationprovider.deleteAccountForm.markAllAsTouched();
                     showErrorToast(
