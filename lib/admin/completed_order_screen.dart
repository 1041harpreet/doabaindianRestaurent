...
import 'complete_order_detail_page.dart';

class CompletedOrderScreen extends ConsumerStatefulWidget {
  const CompletedOrderScreen({Key? key}) : super(key: key);

  @override
  ConsumerState<CompletedOrderScreen> createState() => _CompletedOrderScreenState();
}
...
class _CompletedOrderScreenState extends ConsumerState<CompletedOrderScreen> {
  ...
  void initState() {
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ref.watch(orderProvider).getCompOrders();
    });
    super.initState();
  }
      ...
      child: Scaffold(
          appBar: AppBar(
              ...
              actions: [
                  ...
                  itemBuilder: (BuildContext bc) {
                    return [
                      PopupMenuItem(
                        ...
                        value: '/all',
                        child: Text("See All Orders", style: AppConfig.blackTitle),
                      ),
                ...
                IconButton(
                    onPressed: () async{
                      await orderprovider.getCompOrders();
                    },
              ...
              return GestureDetector(
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => CompletedOrderDetail(
                            index: index,
                            orderList:
                            orderprovider.compOrderList,
                            doc: orderprovider
                                .compOrderList[index]
                                .date +
                                orderprovider
